...
- [x] TASK-5.5: Generate 10-page learning script for Edge AI Lesson 5 — "Bare-Metal Kernel Optimization for Real-Time Execution" (1 quiz Q). Add to tracks[3].lessons[4].learning_script.
- [x] TASK-5.6: Generate 10-page learning script for Edge AI Lesson 6 — duplicate of Lesson 5. Generate fresh variant for tracks[3].lessons[5].learning_script.

...
- [ ] TASK-2.1: Generate 10-page learning script for AI Engineer Lesson 1 — "Architectural Mastery: Vision Transformers & Multi-Modal Models" (20 quiz Qs). Add to `drone_training.json` tracks[0].lessons[0].learning_script.
- [ ] TASK-2.2: Generate 10-page learning script for AI Engineer Lesson 2 — "Parameter-Efficient Fine-Tuning (PEFT)" (20 quiz Qs). Add to tracks[0].lessons[1].learning_script.
